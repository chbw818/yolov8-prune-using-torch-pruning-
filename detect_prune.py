...
#    pruning_cfg['data'] = "custom_dataset/mydataset.yaml"
#    pruning_cfg['epochs'] = 50
#
#    model.model.train()
...
#    model.export(format='onnx')
	model=YOLO("./runs/detect/step_2_finetune/weights/best.pt")
	model.val(data='./custom_dataset/mydataset2.yaml')

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--model', default='./runs/detect/train6/weights/last.pt', help='Pretrained pruning target model file')
